  ...
  <div :class="ns.b()">
    <div :class="ns.b('header')">
      <el-form :class="ns.e('form')" ref="queryRef" :model="queryParams" :inline="true">
        ...
        <el-form-item>
          <el-button v-hasPermi="['structure:bridgeInfo:search']" type="primary" icon="Search" @click="handleSearch">查询</el-button>
          <el-button v-hasPermi="['structure:bridgeInfo:reset']" icon="Refresh" @click="handleReset">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
      ...
      <div :class="ns.b('content-table')">
        <el-table :data="tableList" style="width: 100%; height: calc(100% - 0.5rem)" empty-text="暂无数据">
          ...
          <el-table-column label="操作" align="center">
            <template #default="scope">
              <el-button v-hasPermi="['structure:bridgeInfo:view']" icon="View" circle @click="handleView(scope.row)"></el-button>
              <el-button v-hasPermi="['structure:bridgeInfo:edit']" icon="Edit" circle @click="handleEdit(scope.row)"></el-button>
              <el-button v-hasPermi="['structure:bridgeInfo:delete']" icon="Delete" circle @click="handleDelete(scope.row)"></el-button>
